...
* [GraphQL Shield](https://github.com/maticzav/graphql-shield) ⭐ 3,577 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-15 - Helps you create a permission layer for your application.
...
* [GraphQL Armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 588 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-16 - Highly customizable security middleware for Apollo GraphQL and Envelop servers.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,322 | 🐛 825 | 🌐 TypeScript | 📅 2026-09-16 - Online REST and GraphQL client
...
* [Clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,520 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Patrial introspection fetcher when introspection is disabled.
* [Graphw00f](https://github.com/dolevf/graphw00f) ⭐ 901 | 🐛 3 | 🌐 Python | 📅 2026-05-16 - GraphQL Server Engine Fingerprinting utility.
...
* [InQL](https://github.com/doyensec/inql) ⭐ 1,813 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-09 - A Burp Extension for GraphQL Security Testing.
