...
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 692 | 🐛 4 | 🌐 Python | 📅 2025-11-20 - Utility to run common security tests against GraphQL APIs that can be run inside CI/CD.
...
* [GraphQL Armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 588 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-23 - Highly customizable security middleware for Apollo GraphQL and Envelop servers.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,482 | 🐛 825 | 🌐 TypeScript | 📅 2026-09-23 - Online REST and GraphQL client
...
* [Voyager](https://github.com/IvanGoncharov/graphql-voyager) ⭐ 8,170 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,767 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-23 – Validate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [Clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,528 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Patrial introspection fetcher when introspection is disabled.
...
* [InQL](https://github.com/doyensec/inql) ⭐ 1,812 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-09 - A Burp Extension for GraphQL Security Testing.
...
* [GraphQL wordlist](https://github.com/Escape-Technologies/graphql-wordlist) ⭐ 486 | 🐛 1 | 🌐 TypeScript | 📅 2023-10-03 - the only GraphQL wordlist for pentesting you'll ever need. Operations, field names, type names. It was collected on more than 60k distinct GraphQL schemas.
