...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,201 | 🐛 810 | 🌐 TypeScript | 📅 2026-08-31 - Online REST and GraphQL client
...
* [GraphQL Inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,764 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-20 – Validate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [GraphQLMap](https://github.com/swisskyrepo/GraphQLmap) ⭐ 1,690 | 🐛 20 | 🌐 Python | 📅 2024-03-11 - A scripting engine to interact with a GraphQL endpoint for pentesting purposes.
