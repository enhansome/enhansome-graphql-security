...
* [GraphQL Shield](https://github.com/maticzav/graphql-shield) ⭐ 3,579 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-03 - Helps you create a permission layer for your application.
...
* [GraphQL Armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 587 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-04 - Highly customizable security middleware for Apollo GraphQL and Envelop servers.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,209 | 🐛 811 | 🌐 TypeScript | 📅 2026-08-31 - Online REST and GraphQL client
...
* [GraphMan](https://github.com/Escape-Technologies/graphman) ⭐ 253 | 🐛 7 | 🌐 TypeScript | 📅 2024-08-26 - Generate a complete Postman collection from a GraphQL endpoint. Allows instant and easy discovery and exploration of the API.

### Visualizers

* [Voyager](https://github.com/IvanGoncharov/graphql-voyager) ⭐ 8,164 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,765 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-20 – Validate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [Clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,515 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Patrial introspection fetcher when introspection is disabled.
* [Graphw00f](https://github.com/dolevf/graphw00f) ⭐ 896 | 🐛 3 | 🌐 Python | 📅 2026-05-16 - GraphQL Server Engine Fingerprinting utility.
...
* [InQL](https://github.com/doyensec/inql) ⭐ 1,805 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 - A Burp Extension for GraphQL Security Testing.
* [GraphQLMap](https://github.com/swisskyrepo/GraphQLmap) ⭐ 1,689 | 🐛 20 | 🌐 Python | 📅 2024-03-11 - A scripting engine to interact with a GraphQL endpoint for pentesting purposes.
...
* [BatchQL](https://github.com/assetnote/batchql) ⭐ 414 | 🐛 5 | 🌐 Python | 📅 2022-12-24 - GraphQL security auditing script with a focus on performing batch GraphQL queries and mutations.
* [GraphQL Threat Matrix](https://github.com/nicholasaleks/graphql-threat-matrix) ⭐ 370 | 🐛 9 | 📅 2025-07-01 - GraphQL threat framework to research security gaps in GraphQL implementations.
* [CrackQL](https://github.com/nicholasaleks/CrackQL) ⭐ 352 | 🐛 0 | 🌐 Python | 📅 2024-08-03 - GraphQL password brute-force and fuzzing utility.
...
* [Damn Vulnerable GraphQL Application](https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application) ⭐ 1,709 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24 - An intentionally vulnerable implementation of Facebook's GraphQL technology, to learn and practice GraphQL Security.
