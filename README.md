...
* [GraphQL Shield](https://github.com/maticzav/graphql-shield) ⭐ 3,577 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-07 - Helps you create a permission layer for your application.
...
* [GraphQL Armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 587 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-08 - Highly customizable security middleware for Apollo GraphQL and Envelop servers.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,250 | 🐛 814 | 🌐 TypeScript | 📅 2026-09-08 - Online REST and GraphQL client
...
* [Voyager](https://github.com/IvanGoncharov/graphql-voyager) ⭐ 8,167 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,767 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-20 – Validate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [Clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,517 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Patrial introspection fetcher when introspection is disabled.
...
* [InQL](https://github.com/doyensec/inql) ⭐ 1,806 | 🐛 29 | 🌐 Kotlin | 📅 2026-09-08 - A Burp Extension for GraphQL Security Testing.
...
* [BatchQL](https://github.com/assetnote/batchql) ⭐ 418 | 🐛 5 | 🌐 Python | 📅 2022-12-24 - GraphQL security auditing script with a focus on performing batch GraphQL queries and mutations.
...
* [Damn Vulnerable GraphQL Application](https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application) ⭐ 1,710 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24 - An intentionally vulnerable implementation of Facebook's GraphQL technology, to learn and practice GraphQL Security.
