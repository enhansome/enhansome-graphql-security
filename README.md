...
* [GraphQL Shield](https://github.com/maticzav/graphql-shield) ⭐ 3,578 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-12 - Helps you create a permission layer for your application.
...
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 684 | 🐛 4 | 🌐 Python | 📅 2025-11-20 - Utility to run common security tests against GraphQL APIs that can be run inside CI/CD.

### Middlewares

* [GraphQL Armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 585 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-11 - Highly customizable security middleware for Apollo GraphQL and Envelop servers.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,022 | 🐛 783 | 🌐 TypeScript | 📅 2026-08-05 - Online REST and GraphQL client
...
* [Voyager](https://github.com/IvanGoncharov/graphql-voyager) ⭐ 8,158 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,757 | 🐛 138 | 🌐 TypeScript | 📅 2026-06-17 – Validate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [CraftQL](https://github.com/yamafaktory/craftql) ⭐ 112 | 🐛 0 | 🌐 Rust | 📅 2023-05-18 - CLI GraphQL schema viewer, view schema diagram on the terminal or generate graphviz .dot format file

## Offensive Security

### Discovery

* [Clairvoyance](https://github.com/nikitastupin/clairvoyance) ⭐ 1,502 | 🐛 42 | 🌐 Python | 📅 2025-12-05 - Patrial introspection fetcher when introspection is disabled.
* [Graphw00f](https://github.com/dolevf/graphw00f) ⭐ 886 | 🐛 3 | 🌐 Python | 📅 2026-05-16 - GraphQL Server Engine Fingerprinting utility.
...
* [InQL](https://github.com/doyensec/inql) ⭐ 1,798 | 🐛 30 | 🌐 Kotlin | 📅 2026-06-17 - A Burp Extension for GraphQL Security Testing.
...
* [GraphQL Threat Matrix](https://github.com/nicholasaleks/graphql-threat-matrix) ⭐ 368 | 🐛 9 | 📅 2025-07-01 - GraphQL threat framework to research security gaps in GraphQL implementations.
...
* [Damn Vulnerable GraphQL Application](https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application) ⭐ 1,703 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24 - An intentionally vulnerable implementation of Facebook's GraphQL technology, to learn and practice GraphQL Security.
...
Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/Escape-Technologies/awesome-graphql-security/blob/main/CONTRIBUTING.md) ⭐ 396 | 🐛 2 | 📅 2026-07-16 first.

We will keep some pull requests open if we are not sure whether those libraries are awesome, you could [vote for them](https://github.com/Escape-Technologies/awesome-graphql-security/pulls) ⭐ 396 | 🐛 2 | 📅 2026-07-16 by adding :+1: to them.
