...
* [GraphQL Shield](https://github.com/maticzav/graphql-shield) ⭐ 3,576 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-24 - Helps you create a permission layer for your application.
...
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 693 | 🐛 4 | 🌐 Python | 📅 2025-11-20 - Utility to run common security tests against GraphQL APIs that can be run inside CI/CD.
...
* [GraphQL Armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 588 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-24 - Highly customizable security middleware for Apollo GraphQL and Envelop servers.
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,510 | 🐛 833 | 🌐 TypeScript | 📅 2026-09-25 - Online REST and GraphQL client
...
* [GraphQL Inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,769 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-23 – Validate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [GraphQL wordlist](https://github.com/Escape-Technologies/graphql-wordlist) ⭐ 487 | 🐛 1 | 🌐 TypeScript | 📅 2023-10-03 - the only GraphQL wordlist for pentesting you'll ever need. Operations, field names, type names. It was collected on more than 60k distinct GraphQL schemas.
...
* [Damn Vulnerable GraphQL Application](https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application) ⭐ 1,713 | 🐛 3 | 🌐 JavaScript | 📅 2025-05-24 - An intentionally vulnerable implementation of Facebook's GraphQL technology, to learn and practice GraphQL Security.
